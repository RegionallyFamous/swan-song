...
EXPECTED = (
    (0xC0, 0x10, 52, 0xF0003),
    (0xC1, 0x21, 54, 0xF0007),
    (0xC2, 0x32, 56, 0xF000B),
    (0xC3, 0x43, 58, 0xF000F),
    (0xC0, 0x55, 60, 0xF0014),
    (0xC1, 0x66, 60, 0xF0014),
    (0xCF, 0x54, 62, 0xF0018),
    (0xD0, 0x03, 64, 0xF001D),
    (0xD1, 0x01, 64, 0xF001D),
    (0xD2, 0x04, 66, 0xF0022),
    (0xD3, 0x02, 66, 0xF0022),
    (0xD4, 0x05, 68, 0xF0027),
    (0xD5, 0x03, 68, 0xF0027),
    (0xCE, 0x01, 70, 0xF002B),
)
