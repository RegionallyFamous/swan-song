...
EXPECTED_ROWS = (
    ExpectedRow("pre-enable-readback", 4079, "bank", 0xC0, ord("P"), instruction_id=89, origin_pc=983134),
    ExpectedRow("one-shot-byte-0", 5730, "mem", 0xF1000, 20017, mapped_offset=0x11000),
    ExpectedRow("one-shot-byte-1", 7278, "mem", 0xF1001, 78, mapped_offset=0x11001),
    ExpectedRow("one-shot-byte-2", 8874, "mem", 0xF1002, 34923, mapped_offset=0x11002),
    ExpectedRow("one-shot-terminal", 10307, "bank", 0xC0, ord("O"), instruction_id=207, origin_pc=983211),
    ExpectedRow("zero-length-restart-rejected", 33251, "bank", 0xC0, ord("N"), instruction_id=492, origin_pc=983296),
    ExpectedRow("pause-first-byte", 35442, "mem", 0xF1010, 7681, mapped_offset=0x11010),
    ExpectedRow("pause-frozen-counters", 59243, "bank", 0xC0, ord("S"), instruction_id=836, origin_pc=983451),
    ExpectedRow("resume-next-byte", 60510, "mem", 0xF1011, 30, mapped_offset=0x11011),
    ExpectedRow("resume-final-byte", 62046, "mem", 0xF1012, 22587, mapped_offset=0x11012),
    ExpectedRow("resume-terminal", 63263, "bank", 0xC0, ord("R"), instruction_id=909, origin_pc=983519),
    ExpectedRow("active-edit-original-byte", 65454, "mem", 0xF1020, 61137, mapped_offset=0x11020),
    ExpectedRow("active-edit-readback", 66851, "bank", 0xC0, ord("E"), instruction_id=977, origin_pc=983619),
    ExpectedRow("active-edit-new-byte-0", 67002, "mem", 0xF1030, 48801, mapped_offset=0x11030),
    ExpectedRow("active-edit-new-byte-1", 68538, "mem", 0xF1031, 190, mapped_offset=0x11031),
    ExpectedRow("active-edit-terminal", 69767, "bank", 0xC0, ord("A"), instruction_id=1030, origin_pc=983683),
    ExpectedRow("repeat-original-byte", 71946, "mem", 0xF1040, 36465, mapped_offset=0x11040),
    ExpectedRow("repeat-shadow-byte-0", 73482, "mem", 0xF1050, 24129, mapped_offset=0x11050),
    ExpectedRow("repeat-shadow-byte-1", 75066, "mem", 0xF1051, 94, mapped_offset=0x11051),
    ExpectedRow("repeat-shadow-reload", 76595, "bank", 0xC0, ord("T"), instruction_id=1157, origin_pc=983808),
    ExpectedRow("decrement-byte-3", 78474, "mem", 0xF1063, 104, mapped_offset=0x11063),
    ExpectedRow("decrement-byte-2", 79986, "mem", 0xF1062, 26699, mapped_offset=0x11062),
    ExpectedRow("decrement-byte-1", 81522, "mem", 0xF1061, 46, mapped_offset=0x11061),
    ExpectedRow("decrement-byte-0", 83106, "mem", 0xF1060, 11793, mapped_offset=0x11060),
    ExpectedRow("decrement-terminal", 84539, "bank", 0xC0, ord("D"), instruction_id=1308, origin_pc=983909),
    ExpectedRow("hold-frozen-byte-1", 86778, "mem", 0xF1070, 65249, mapped_offset=0x11070),
    ExpectedRow("hold-live-zero-byte", 88326, "mem", 0xF1070, 65249, mapped_offset=0x11070),
    ExpectedRow("hold-reenabled-byte", 91290, "mem", 0xF1070, 65249, mapped_offset=0x11070),
    ExpectedRow("hold-zero-and-frozen", 92675, "bank", 0xC0, ord("H"), instruction_id=1461, origin_pc=984176),
    ExpectedRow("unhold-next-byte", 92886, "mem", 0xF1070, 65249, mapped_offset=0x11070),
    ExpectedRow("unhold-final-byte", 94362, "mem", 0xF1071, 254, mapped_offset=0x11071),
    ExpectedRow("unhold-terminal", 95747, "bank", 0xC0, ord("U"), instruction_id=1519, origin_pc=984253),
    ExpectedRow("terminal-success", 95843, "bank", 0xC0, ord("Z"), instruction_id=1521, origin_pc=984257),
)
...
TRACE_SHA256 = "a7c7c0568afb9312de5bd52c159cba4a3cbbe9ece62e25eea29e8869ee223bf6"
