...
; Copyright (c) 2026 Yokoi contributors
; Modified by Regionally Famous for Yokoi Boot on 2026-07-19.
;
; Yokoi Boot is a modified version of BootFriend. It is free software: you
...
org 0x0000
	...
	db 'y', 'K', 't' ; Yokoi splash marker/padding
	db 'M' ; Console flags
...
%else
	...
	dw ffffPointer
%endif
	dw 0x800 + (4 * 64) + (10 * 2) ; Horizontal: centered 64 x 64 mark
	dw 0x800 + (9 * 64) + (5 * 2) ; Vertical: centered 64 x 64 mark
	db 8 ; Tilemap width
	db 8 ; Tilemap height
...
bootFriendVersion:
	db 0x10 ; Yokoi Boot 1.0, reported as BF10 for host compatibility
...
paletteData:
	dw 0x0FFF
	dw 0x0DDD
	dw 0x026C ; Yokoi blue, RGB(2, 6, 12)
	dw 0x0234 ; Yokoi charcoal, RGB(2, 3, 4)

tilesetData:
	incbin "build/yokoi_logo.2bpp"

tilemapData:
	%assign tileIndex 0
	%rep 64
		dw tileIndex
		%assign tileIndex tileIndex + 1
	%endrep
