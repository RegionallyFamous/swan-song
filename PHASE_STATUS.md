...
| Display-to-writer correlation | Verified on open regression | complete-from-reset manifest plus byte-lane IRAM scoreboard matches all 80,202 physical fetches: 79,760 exact CPU writers, 442 defined power-up reads, zero mismatches/collisions; `correlate_provenance.py` |
