...
- native horizontal/vertical input orientation, every `Display Orientation`
  setting, `Landscape 180°`, triple buffer, all flicker modes, generic
  mono/color display modes, grayscale response, and screenshots;
