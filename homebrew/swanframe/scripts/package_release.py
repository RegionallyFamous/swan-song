...
"""Create the deterministic, source-inclusive SWANFRAME public release."""
...
NAME = f"swanframe-{RELEASE_VERSION}"
ROM_SOURCE = ROOT / "swanframe.wsc"
...
def main() -> int:
    ...
    files = package_files()
    manifest = {
        "schema": "swanframe-package-manifest-v1",
